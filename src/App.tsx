...
import { ProcessedOrder, ProcessingStatus, OrphanedPackingSlip } from './types';
...
function App() {
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      const { groups, orphanedSlips, totalPackingSlipsDetected, totalShippingLabelsDetected } = await analyzePDF(file);

      console.log('Analysis complete:', { groups, orphanedSlips, totalPackingSlipsDetected, totalShippingLabelsDetected });
